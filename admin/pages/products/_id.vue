...
export default {
  async asyncData({ $axios, params }) {
    try {
      ...
      let product = $axios.$get(`http://localhost:6000/api/products/${params.id}`);
  ...
  methods: {
    ...
    async onUpdateProduct() {
      ...
      let result = await this.$axios.$put(`http://localhost:6000/api/products/${this.$route.params.id}`,data);
