                    ...
                    <div class="a-section">
                        ...
                        <form>
                            ...
                            <div class="a-spacing-top-medium">
                                ...
                                <textarea placeholder="Provide details sucg as a product description" style="width: 100%" v-model="description" ></textarea>
                            </div>
...
export default {
    async asyncData({ $axios }){
        try {
            let categories = $axios.$get("http://localhost:6000/api/categories");
            let owners = $axios.$get("http://localhost:6000/api/owners");
    ...
    methods:{
        ...
        async onAddProduct(){
            ...
            let result= await this.$axios.$post("http://localhost:6000/api/products",data);
